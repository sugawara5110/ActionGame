...
void update() {
	...
	DxText::GetInstance()->
		UpDateText(DxText::GetInstance()->getStr("岩男の体力 %d",sk1->getCollisionParameter(0)->HP), 100, 40.0f, 30, {1.0f, 1.0f, 1.0f, 1.0f});
	DxText::GetInstance()->
		UpDateText(DxText::GetInstance()->getStr("人間の体力 %d",en->getCollisionParameter(0)->HP), 100, 70.0f, 30, {1.0f, 1.0f, 1.0f, 1.0f});
	DxText::GetInstance()->
